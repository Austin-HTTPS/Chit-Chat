...
// Save data about private DM's 

document.getElementById('private-message').addEventListener('click', e => {

  sessionStorage.setItem('DM-user', sessionStorage.getItem('profile-visiting'));

  window.location.href = "private-message";
